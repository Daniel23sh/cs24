  ...
  return (
    ...
    <div className="min-h-screen bg-[#f9f9f9]">
      ...
      <div className="container mx-auto px-4 py-8 pt-24" style={{ maxWidth: '800px', direction: 'ltr', textAlign: 'left' }}>
        <h1 className={`${styles.textSecondary} text-4xl font-bold mb-4`}>Privacy Policy</h1>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Interpretation and Definitions</h2>
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Interpretation</h3>
          ...
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Definitions</h3>
          <p className="mb-4">For the purposes of this Privacy Policy:</p>
          <ul className="list-disc pl-5 mb-4 space-y-1">
            <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
            <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to דניאל זיו (or anyone on his behalf), doing business as CS24, Ya'akov Fichman St 18, holon 5810201.</li>
            ...
            <li><strong>Website</strong> refers to cs24, accessible from https://cs24.co.il</li>
            <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
          </ul>
        </section>

        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Collecting and Using Your Personal Data</h2>
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Types of Data Collected</h3>
          
          <h4 className={`${styles.textSecondary} text-lg font-bold mb-2`}>Personal Data</h4>
          ...
          <h4 className={`${styles.textSecondary} text-lg font-bold mb-2`}>Usage Data</h4>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Information from Third-Party Social Media Services</h2>
          <p className="mb-2">The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:</p>
          <ul className="list-disc pl-5 mb-4 space-y-1">
            <li>Google</li>
            <li>Facebook</li>
            <li>Instagram</li>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Tracking Technologies and Cookies</h2>
          ...
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Necessary / Essential Cookies</h3>
          <ul className="list-disc pl-5 mb-4 space-y-1">
          ...
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Cookies Policy / Notice Acceptance Cookies</h3>
          <ul className="list-disc pl-5 mb-4 space-y-1">
          ...
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Functionality Cookies</h3>
          <ul className="list-disc pl-5 mb-4 space-y-1">
            <li><strong>Type:</strong> Persistent Cookies</li>
            <li><strong>Administered by:</strong> Us</li>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Use of Your Personal Data</h2>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Retention of Your Personal Data</h2>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Transfer of Your Personal Data</h2>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Delete Your Personal Data</h2>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Disclosure of Your Personal Data</h2>
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Business Transactions</h3>
          ...
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Law enforcement</h3>
          ...
          <h3 className={`${styles.textSecondary} text-xl font-bold mb-2`}>Other legal requirements</h3>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Security of Your Personal Data</h2>
          <p className="mb-4">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
        </section>

        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Children's Privacy</h2>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Links to Other Websites</h2>
        ...
        <section className="mb-8">
          <h2 className={`${styles.textSecondary} text-2xl font-bold mb-4`}>Changes to this Privacy Policy</h2>
