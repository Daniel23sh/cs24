  ...
  return (
    <div className="block p-4 relative z-20">
      <div className="max-w-6xl mx-auto -mb-8">
        <div className={`bg-white border ${styles.cardBorder} rounded-xl shadow-md overflow-hidden flex flex-col md:flex-row mx-auto`}>
          ...
          {/* Left column: Role above Subjects */}
